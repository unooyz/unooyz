...
print("6. True or 1==1 = %s" % str(True or (1==1)))
print("7. False and 0!=0 = %s" % str(False and (0!=0)))
print("8. True or 1==1 = %s" % str(True and (1==1)))
...
print("14. not(1==1 and 0!=1 - %s" % (not ((10==1) or (0 != 1))))
...
print("extra1. 'test' and 'test' == %s" % str('test'and'test'))
print("extra2. 1and 1 ==%s" % str(1 and 1))
print("extra3. False and 1 == %s" % str(False and 1))
print("extra4. True and 1 = %s" % str(True and 1))
